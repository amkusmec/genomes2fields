...
for i in `seq 1 10`; do
  ...
  ~/htslib/tabix -p vcf NAM_imputed_chrom${i}_filt.vcf.gz
  
  # Filter and impute combined G2F/Ames SNPs
  ~/htslib/bgzip G2F_Ames_combined_chrom${i}.vcf
  ~/htslib/tabix -p vcf G2F_Ames_combined_chrom${i}.vcf.gz
  ...
  ~/htslib/tabix -p vcf G2F_Ames_combined_chrom${i}_filt.vcf.gz
  ...
  ~/htslib/bgzip -d G2F_Ames_combined_chrom${i}_imputed.vcf.gz
  ~/htslib/bgzip G2F_Ames_combined_chrom${i}_imputed.vcf
  ~/htslib/tabix -p vcf G2F_Ames_combined_chrom${i}_imputed.vcf.gz
  ...
  ~/htslib/tabix -p vcf G2F_Ames_combined_chrom${i}_imp_filt.vcf.gz
